...
import cn.dyx.domain.rebate.model.entity.TaskEntity;
import cn.dyx.domain.rebate.model.valboj.BehaviorTypeVO;
import cn.dyx.domain.rebate.model.valboj.DailyBehaviorRebateVO;
import cn.dyx.domain.rebate.repository.IBehaviorRebateRepository;
import cn.dyx.infrastructure.event.EventPublisher;
import cn.dyx.infrastructure.persistent.dao.IDailyBehaviorRebateDao;
import cn.dyx.infrastructure.persistent.dao.ITaskDao;
import cn.dyx.infrastructure.persistent.dao.IUserBehaviorRebateOrderDao;
                ...
                try {
                    for (BehaviorRebateAggregate behaviorRebateAggregate : behaviorRebateAggregates) {
                        BehaviorRebateOrderEntity behaviorRebateOrderEntity =
                                behaviorRebateAggregate.getBehaviorRebateOrderEntity();
                        // 用户行为返利订单对象
